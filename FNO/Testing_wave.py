...
im1 = axs[0].contourf(u_0[0,:,:,1],u_0[0,:,:,2],input_batch[23,:,:,0],levels = 64,cmap="jet")
...
im2 = axs[1].contourf(u_0[0,:,:,1],u_0[0,:,:,2],output_pred_batch.detach()[23,:,:,0],levels = 64,cmap="jet")
...
plt.savefig('../assets/FNO_k24.png', dpi=150)