...
if len(sys.argv) == 1:
    ...
    folder = "../../model/Diffusion/"+"CNO_"+which_example
...
res = 64
data_path_input = '../../Dataset/diffusion/64_64/u0s_d6.npy'
data_path_output = '../../Dataset/diffusion/64_64/uTs_d6.npy'
...
im1 = axs[0].contourf(x_grid,y_grid,output_batch[20,0,:,:],levels = 64,cmap="jet")
#im1 = axs[0].imshow(output_batch[20, 0, :, :], cmap="jet")
axs[0].set_xlabel("x1")
axs[0].set_ylabel("x2")
...
im2 = axs[1].contourf(x_grid,y_grid,output_pred_batch.detach()[20,0,:,:],levels = 64,cmap="jet")
...
plt.savefig('../assets/CNO_d6.png' , dpi=150)